...
/*   Updated: 2021/06/05 09:21:21 by amoussai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << this->name << " hit a NinjaTrap by a A A A ... something!" << std::endl;
	trap.takeDamage(10);
}
void NinjaTrap::ninjaShoebox(ScavTrap &trap)
{
	std::cout << this->name << " hit a ScavTrap, it doesn't matter with what!!!! but he hit it!" << std::endl;
	trap.takeDamage(10);
}
